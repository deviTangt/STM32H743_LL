...
#ifndef __USER_TIMER3_H__	// begin of __USER_TIMER3_H__
#define __USER_TIMER3_H__
...
//? 通用定时器Timer3(16位)
extern inline void timer3_config_init(uint16_t _Prescaler, uint32_t _Autoreload);
...
//*******************************// end_h                   //************************************//
#endif	// end of __USER_TIMER3_H__
